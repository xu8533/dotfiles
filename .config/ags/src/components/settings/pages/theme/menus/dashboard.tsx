    ...
    return (
        ...
        >
            <box vertical>
                ...
                <Option opt={options.theme.bar.menus.menu.dashboard.powermenu.shutdown} title="关机" type="color" />
                <Option opt={options.theme.bar.menus.menu.dashboard.powermenu.restart} title="重启" type="color" />
                <Option opt={options.theme.bar.menus.menu.dashboard.powermenu.logout} title="注销" type="color" />
                <Option opt={options.theme.bar.menus.menu.dashboard.powermenu.sleep} title="休眠" type="color" />
                <Option
